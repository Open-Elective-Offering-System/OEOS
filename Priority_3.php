<?php
include('config.php');
$sql_1 = "create table sorted_students_3 as (select * from reg_students where status = '0' ORDER BY CGPA DESC)";
...
while($x <= $cnt) {
    ...
    $eid=0;
    $sql_4 = "select ENROLL_ID from sorted_students_3 where T_Priority = '$sid'";
